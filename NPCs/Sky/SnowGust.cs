...
namespace Critters.NPCs.Sky
{
    public class SnowGust : ModNPC
    {
        ...
        public override void SetDefaults()
        {
			...
			NPC.catchItem = ModContent.ItemType<SnowGustItem>();
			Banner = NPC.type;
			BannerItem = ModContent.ItemType<SnowGustBanner>();
            NPC.height = 34;
			NPC.damage = 0;
			NPC.npcSlots = 0;
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
	        if (NPC.life <= 0)
	        {
		        ...
		        {
			        int num622 = Dust.NewDust(new Vector2(NPC.position.X, NPC.position.Y), NPC.width, NPC.height, DustID.Cloud, 0f, 0f, 100, default(Color), 1f);
    	...
    	{
    		npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SnowGustItem>(), 2));
    	}

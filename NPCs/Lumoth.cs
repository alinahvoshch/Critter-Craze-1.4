...
namespace Critters.NPCs
{
	public class Lumoth : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			NPC.catchItem = ModContent.ItemType<LumothItem>();
			...
			Banner = NPC.type;
			BannerItem = ModContent.ItemType<LumothBanner>();
		}
		
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
	        CrittersUtility.DrawNPCGlowMask(spriteBatch, NPC, ModContent.Request<Texture2D>("Critters/NPCs/Masks/Lumoth_Glow").Value, screenPos);
        }
